% > **HISTORICAL (superseded 2026-07-10).** This draft is superseded by
% > `dealerless_orca_ringlpn_proposal_v2_2026_07_10.tex` (restructured per
% > advisor feedback: problem / motivation / design / experiment-setup;
% > real figures added; "Figure 2" now named the BCG+20 generator; the
% > regular-noise keygen cost row re-derived per DPF tree instead of per
% > SPFSS instance; bootstrap condition c^2 t^2 < n added). Statements
% > below may describe an older state; trust CLAUDE.md and the v2 document.
