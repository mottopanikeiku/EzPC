% Dealerless Orca Ring-LPN proposal, v2.7 (2026-08-06).
...
GPU Ring-LPN Design, Proof Boundary, and Evaluation (v2.7)}
\author{Alp}
\date{2026-08-06 \quad (v2.7; executable self-bootstrap and GPU reduction)}
...
\item[Open --- performance engineering.] Phase B is now the largest measured
  ...
  2.0\%. Evaluate a source-reviewed batched DMPF/P-DPF construction that reduces
  the per-point Phase-A/B work, independently review the measured EMP-Silent
  revision, reduce dependency layers, and remeasure traffic/memory at pinned
  parameters. The present $831\times$ median dealer gap is not competitive.
...
(2)~evaluation of a source-reviewed DMPF/P-DPF route for the remaining
Phase-A/B point-key cost, independent EMP-Silent review, and renewed stage,
byte, dependency-layer, and memory measurements;
