...
| `reports/dealerless_ole_two_party_keys_memo_2026_07_29.md` | **M2 CORE GATE**: the real Figure 2 OLE engine validating on SPFSS keys generated by two OS processes over real OT, in all four deployed configurations; measured keygen stages/bytes/time per limb, the regular-vs-uniform keygen gap, and the oracles that remain |
