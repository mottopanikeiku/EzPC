...
| `reports/dealerless_orca_ringlpn_proposal_v2_2026_07_10.tex` (+`.pdf`) | **CURRENT proposal (v2.3, 2026-07-29)**: S1 ideal functionality/transcript/leakage/simulators/proof obligations; corrected split transcript accounting and Table 5; GPU-NTT provenance; M1 status and claims ladder; stable filename; supersedes the 2026-06-10 draft |
